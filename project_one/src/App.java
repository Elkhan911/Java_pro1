...
public class App {
  public static void main(String[] args) throws Exception {
    ...
    /*
     * 1P. Выведи в консоль «Я автоматизатор».
     */

    System.out.println("Я автоматизатор");

    /*
     * 2P. За неделю на карантине дизайнер Олег 132 минуты смотрел «Офис», 240 минут
     * — «Острые козырьки», 153 минуты — «Очень странные дела» и 255 минут — «Рика и
     * Морти».
     * Выведи в консоль, сколько всего часов Олег потратил на просмотр.
     */
